...
class NeuralNetwork:
    ...
    def initialise_params(self):
        ...
        for l, (n_in, n_out) in enumerate(
            zip(self.layer_sizes[:-1], self.layer_sizes[1:]), 1
        ):
    ...
    def forward(self, X):
        ...
        for l in range(1, L + 1):
            ...
            Z = A_prev @ self.params_[f'W{l}'].T + self.params_[f'b{l}']
        ...
        for l in range(L, 0, -1):
            ...
            if l > 1:
                ...
                dZ = dA * self._activation_derivative(
                    cache[f'Z{l-1}'], self.activations[l - 2]
                )
    ...
    def update_params(self, grads, lr):
        ...
        L = len(self.layer_sizes) - 1
        for l in range(1, L + 1):
            self.params_[f'W{l}'] -= lr * grads[f'dW{l}']
            self.params_[f'b{l}'] -= lr * grads[f'db{l}']
    ...
    # ── Section 3 — sklearn compatibility (Task 5.1) ─────────────────────────

    def get_params(self, deep=True):
        """Return constructor parameters (required by sklearn)."""
        return {
    ...
    def set_params(self, **params):
        """Set constructor parameters (required by sklearn)."""
        for key, value in params.items():
            setattr(self, key, value)
        return self

    def score(self, X, y):
        """Accuracy — used by sklearn cross-validation."""
